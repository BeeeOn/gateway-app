...
inline TT_Table fillDeviceTable() {
	...
	modules.insert( {76, TT_Module(76, 0x0C, 4, true, "", "", {true, 0.0}, {true, 60.0}, {}) } );
	...
	modules.insert( {80, TT_Module(80, 0x0C, 4, true, "", "", {true, 0.0}, {true, 60.0}, {}) } );
	...
	modules.insert( {84, TT_Module(84, 0x0C, 4, true, "", "", {true, 0.0}, {true, 60.0}, {}) } );
	...
	modules.insert( {88, TT_Module(88, 0x0C, 4, true, "", "", {true, 0.0}, {true, 60.0}, {}) } );
